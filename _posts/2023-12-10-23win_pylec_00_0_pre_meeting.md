...
다음으로 **Listary**라는 파일찾기 툴을 설치한다. 간편하게 필요한 파일을 찾을 때 유용하다. 다음 웹페이지에서 다운로드 받아서 설치한다. [https://www.listary.com/](https://www.listary.com/). ctrl키를 두번 누르고 찾고싶은 파일 이름을 입력하면 해당 파일이 검색된다.
