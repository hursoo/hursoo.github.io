...
### 3. 엠에디터 설치
텍스트 편집 툴인 엠에디터(Emeditor, 윈도우용)를 로컬 pc에 설치하고 등록한다. 
...
- 설치 완료된 엠에디터를 실행한다. 팝업 메뉴 맨 마지막에 있는 "도움말"의 "Emeditor 소개"에 들어가서 "등록키 입력"을 클릭하고 등록키를 입력한다. 등록키는 깃허브 동일 폴더에 있는 "emed32_13.0.6_등록키.txt"의 여러 키들 중 하나를 선택하면 된다.
